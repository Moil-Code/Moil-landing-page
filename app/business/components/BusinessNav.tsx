...
export function BusinessNav({
  ...
  signinLabel = 'Log In',
  signinHref = 'https://moilapp.com/business',
}: BusinessNavProps) {
  return (
    <nav id="nav" className={scrolled ? 'scrolled' : ''}>
      <a href={logoHref} className="nav-logo">
        {logo ?? (
          <>
            MO<span className="lo">I</span>L <span className="ai-badge">AI Co-Founder</span>
          </>
        )}
      </a>
      ...
      <div className="nav-right">
        ...
        <a className="nav-signin" href={signinHref} target="_blank" rel="noreferrer">
          {signinLabel}
        </a>

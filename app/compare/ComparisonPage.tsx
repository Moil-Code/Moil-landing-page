  ...
  return (
    <main className="comparison-page">
        ...
        <div className="comparison-hero-inner">
          <div className="comparison-hero-copy">
            ...
            <div className="comparison-actions">
              <a className="comparison-primary" href={buildRegisterUrl({ lang: 'en' })} target="_blank" rel="noreferrer" data-signup-cta="compare">
      ...
      <section className="comparison-cta">
        ...
        <a href={buildRegisterUrl({ lang: 'en' })} target="_blank" rel="noreferrer" data-signup-cta="compare">

    ...
    >
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        ...
        <div style={{ width: '100%', borderRadius: 16, overflow: 'hidden', marginBottom: 56 }}>
          <img
            src="https://res.cloudinary.com/daudj5isi/image/upload/v1783397729/moil_vs_claude_lckgyl.png"
            alt="Moil vs Claude comparison banner"
        ...
        <p style={{ fontSize: 16, color: '#a0a0b8', lineHeight: 1.7, maxWidth: 600, marginBottom: 56 }}>
          Claude is an impressive general AI assistant. Moil is an AI co-founder purpose-built for small business owners —
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: 13, fontWeight: 600, color: '#a0a0b8', textAlign: 'center' }}>Claude</span>
          </div>
        ...
        <div style={{ textAlign: 'center', marginTop: 56 }}>
          <p style={{ color: '#a0a0b8', marginBottom: 24, fontSize: 15 }}>
            Ready to go beyond a general assistant and run your business with AI?
          </p>
          <a

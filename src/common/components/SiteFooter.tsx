...
const OWN_FOOTER_PREFIXES = ['/business', '/es', '/help', '/candidate', '/compare', '/about', '/ai-info', '/reviews', '/work', '/partners', '/team', '/contact', '/privacy', '/terms', '/cookies', '/privacy-choices', '/dpa', '/subprocessors', '/dmca', '/accessibility'];

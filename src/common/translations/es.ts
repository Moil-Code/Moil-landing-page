...
export const es: TranslationKeys = {
  ...
  business: {
    ...
    demoVideo: {
      ...
      description: 'Observa cómo un solo espacio conectado avanza desde la primera conversación hasta la investigación de mercado, la estrategia, el contenido y la contratación, manteniendo el contexto de tu negocio en cada paso.',

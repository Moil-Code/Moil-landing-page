...
export const es: TranslationKeys = {
  ...
  business: {
    ...
    hero: {
      ...
      headline: 'Tú llevas el negocio.',
      headlineHighlight: 'Moil lleva el marketing.',
      subheadline: 'Moil aprende tu negocio una vez — qué vendes, quién te compra, cómo hablas — y a partir de ahí escribe tu mes de contenido y lo mantiene al día. En inglés y español. Desde $25 al mes.',
      cta: 'Empieza gratis — sin tarjeta',
      ctaSecondary: 'Pruébalo con tu negocio',
      trust: [
        'Un mes de contenido terminado',
        'Escrito con tu voz',
        'Inglés y español',
    ...
    aeoAnswer: {
      label: '¿Qué es Moil?',
      body: 'Moil es una plataforma de marketing con IA para pequeños negocios. Entrevista al dueño una sola vez sobre qué vende, quién le compra y cómo habla; después arma un calendario de contenidos de 30 días con textos e imágenes, lo renueva cada mes y responde preguntas sobre el negocio usando ese contexto guardado. Funciona por completo en inglés y español. Professional cuesta $25 al mes; el calendario Moil360 completo es Market Pro, $75.',
      ...
      items: [
        {
          ...
          answer: 'Moil aprende tu negocio una sola vez — qué vendes, quién te compra, cómo hablas — y a partir de ahí escribe tu marketing. Arma un calendario de 30 días con textos e imágenes, lo renueva cada mes y responde preguntas sobre tu negocio usando ese contexto. Funciona en inglés y español.',
        },
        {
          question: '¿Cuánto cuesta Moil?',
          answer: 'Professional cuesta $25 al mes e incluye investigación de mercado, tu plan de negocios, coaching y documentos. El calendario Moil360 completo de 30 días es Market Pro, $75. La primera conversación es gratis y no pide tarjeta, y ambos planes funcionan en inglés y español.',
        },
        {

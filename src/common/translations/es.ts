  ...
  business: {
    ...
    hero: {
      ...
      magnet: {
        ...
        waitLonger: 'Este está tardando más de lo normal. Sigue construyéndose — déjanos tu correo y te lo enviamos.',
        ...
        factSource: 'Leído de',
        readSummary: 'Esto es lo que Moil captó de una sola pasada, sin que llenaras un formulario.',
        readThin: 'Es todo lo que pudimos leer desde afuera \u2014 que es justo lo que ve un cliente.',
        nextUp: 'Adentro te hace unas preguntas y convierte esto en el trabajo:',
        nextItems: [

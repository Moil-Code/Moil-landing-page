export const en = {
  ...
  business: {
    ...
    demoVideo: {
      ...
      description: 'Watch one connected workspace move from a first conversation to market research, strategy, content, and hiring — with the context of your business carried through every step.',

export const en = {
  ...
  business: {
    ...
    finalCta: {
      ...
      subheadline: 'Join 500+ small businesses with an AI co-founder in their corner. Business plan, market research, 30-day content calendar, and smart hiring — in one session. Starts at $25/month.',
      cta: 'Start free — no credit card',

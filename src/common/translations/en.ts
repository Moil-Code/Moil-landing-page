  ...
  business: {
    ...
    hero: {
      ...
      magnet: {
        ...
        waitCalm: 'Reading your business…',
        waitLeave: 'Still reading. You can close this page — it keeps building without you.',
        waitLonger: 'This one is taking longer than usual. It is still building — leave your email and we will send it over.',
        ...
        readSummary: 'This is what Moil picked up in one pass, without you filling in a form.',
        readThin: 'That is all we could read from the outside \u2014 which is exactly what a customer sees too.',
        nextUp: 'Inside, it asks you a few questions and turns this into the work:',
        nextItems: [

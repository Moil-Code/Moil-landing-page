...
export const en = {
  ...
  business: {
    ...
    hero: {
      ...
      headline: 'You shouldn\'t have to be',
      headlineHighlight: 'everything',
      headlineLine2: 'on top of the real job.',
      ...
      trustLabel: 'Why business owners choose Moil',
      trust: [
      ...
      previewKicker: 'Moil business preview',
      previewStatus: 'Live',
      previewEyebrow: 'Start with what you already have',
      previewTitle: 'Show Moil your business.',
      previewDescription: 'Paste your website. Moil reads the business, builds its working context, and gives you a first brand preview.',
      previewStepsLabel: 'How the preview works',
      previewStep1: 'Reads your site',
      previewStep2: 'Learns your brand',
      previewStep3: 'Builds your preview',
      magnet: {
        ...
        platformsOr: 'Or',
        readyEyebrow: 'Business profile',
        knowingTitle: 'Your strategy, distilled',
        readyStatus: 'Ready to review',
        sourceLabel: 'Source',
        identityLabel: 'Identity',
        publishingEyebrow: 'Publishing',
        publishingHint: 'Connect or change channels after creating your account.',
        availabilityLabel: 'Other networks',
        cadenceLabel: 'Cadence',
        actionTrust: 'Built from your website. Edit anything before you continue.',
        ...
        headingTagline: 'Tagline',
        headingLanguage: 'Language',
        headingTrust: 'Why people trust them',
        editLabel: 'Edit',
        doneLabel: 'Done',
